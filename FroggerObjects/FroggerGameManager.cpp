...
#include "../GraphicLib/GameObjects/Flare.h";
...
void FroggerGameManager::init() {
	...
	TGA_Texture(TextureArray, "GraphicLib/wood.tga", 0);
	TGA_Texture(TextureArray, "GraphicLib/water.tga", 1);
	TGA_Texture(TextureArray, "GraphicLib/asphalt.tga", 2);
	loadTexture(TextureArray, "GraphicLib/particula.bmp", 3);
	TGA_Texture(TextureArray, "GraphicLib/tree.tga", 4);
	TGA_Texture(TextureArray, "GraphicLib/grass.tga", 5);
	TGA_Texture(TextureArray, "GraphicLib/turtle.tga", 6);
	loadRawTextures(TextureArray, "GraphicLib/flare_textures/crcl.raw", 7);
	loadRawTextures(TextureArray, "GraphicLib/flare_textures/flar.raw", 8);
	loadRawTextures(TextureArray, "GraphicLib/flare_textures/hxgn.raw", 9);
	loadRawTextures(TextureArray, "GraphicLib/flare_textures/ring.raw", 10);
	loadRawTextures(TextureArray, "GraphicLib/flare_textures/sun.raw", 11);
	TGA_Texture(TextureArray, "GraphicLib/head.tga", 12);
